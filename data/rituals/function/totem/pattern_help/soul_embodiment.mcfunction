...
tellraw @a[distance=..10] [{"text":"  • South (+Z): ","color":"gray"},{"text":"Soul Sand","color":"#8B6914","bold":true}]
tellraw @a[distance=..10] [{"text":"  • East (+X): ","color":"gray"},{"text":"Ender Pearl","color":"#0A7A7A","bold":true}]
tellraw @a[distance=..10] [{"text":"  • North (-Z): ","color":"gray"},{"text":"Glowstone Dust","color":"#FFCC00","bold":true}]
