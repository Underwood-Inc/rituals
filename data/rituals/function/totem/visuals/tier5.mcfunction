...
data modify storage rituals:temp block set value {Name:"minecraft:blackstone_wall",Properties:{up:"true",north:"none",south:"none",east:"none",west:"none",waterlogged:"false"}}
