...
# Check block at this position and apply growth with 30% random chance
execute if block ~ ~ ~ #minecraft:crops if predicate rituals:random_30_percent run function rituals:ritual/effects/apply_growth_here
