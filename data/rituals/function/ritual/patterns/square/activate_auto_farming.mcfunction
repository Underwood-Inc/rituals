...
execute positioned ~5 ~ ~5 as @e[type=interaction,tag=rituals.totem,distance=..1.5,limit=1,sort=nearest] at @s run function rituals:totem/break_sacrifice with storage rituals:temp
