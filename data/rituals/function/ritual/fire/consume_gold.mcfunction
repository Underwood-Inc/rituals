...
execute positioned ~ ~ ~-2 as @e[type=item,nbt={Item:{id:"minecraft:gold_ingot"}},distance=..1] run kill @s
execute positioned ~ ~ ~2 as @e[type=item,nbt={Item:{id:"minecraft:gold_ingot"}},distance=..1] run kill @s
execute positioned ~2 ~ ~ as @e[type=item,nbt={Item:{id:"minecraft:gold_ingot"}},distance=..1] run kill @s
execute positioned ~-2 ~ ~ as @e[type=item,nbt={Item:{id:"minecraft:gold_ingot"}},distance=..1] run kill @s
...
tellraw @a[distance=..16] [{"text":"[Totem Rituals] ","color":"gold","bold":true},{"text":"Fire sacrifice accepted! ","color":"red"},{"text":"(consumed 4x Gold Ingot)","color":"gray","italic":true}]
