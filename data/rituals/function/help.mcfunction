...
tellraw @s [{"text":"","color":"yellow"}]
tellraw @s [{"text":"Configuration:","color":"orange","bold":true}]
tellraw @s [{"text":"  /function rituals:admin/toggle_debug","color":"aqua","underlined":true,"click_event":{"action":"run_command","command":"/function rituals:admin/toggle_debug"},"hover_event":{"action":"show_text","value":[{"text":"Click to toggle debug mode","color":"green"}]}},{"text":" - Toggle debug mode","color":"white"}]
