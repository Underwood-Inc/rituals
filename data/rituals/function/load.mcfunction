...
tellraw @a [{"text":"║","color":"dark_purple"},{"text":"           🔮 ","color":"light_purple"},{"text":"Rituals","color":"white"},{"text":" - Fire Sacrifice Edition","color":"gray"},{"text":"           ║","color":"dark_purple"}]
tellraw @a [{"text":"╠════════════════════════════════════════════════════════════╣","color":"dark_purple"}]
tellraw @a [{"text":""}]
