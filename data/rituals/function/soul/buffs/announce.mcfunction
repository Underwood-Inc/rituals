...
execute if data storage rituals:temp announce_buff{id:"fireresist"} run tellraw @a[distance=..16] [{"text":"  🔥 ","color":"orange"},{"text":"Flame Ward","color":"gold"},{"text":" - Resist fire damage!","color":"gray"}]
