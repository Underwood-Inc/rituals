...
# Check for Scrying Glass use
execute as @a[nbt={SelectedItem:{components:{"minecraft:custom_data":{rituals_scrying_glass:1b}}}}] at @s run function rituals:soul/check_scrying_use
