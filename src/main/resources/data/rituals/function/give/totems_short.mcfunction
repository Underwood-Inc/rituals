# Give all short totem variants
function rituals:give/totem_basic_short
function rituals:give/totem_copper_short
function rituals:give/totem_advanced_short
