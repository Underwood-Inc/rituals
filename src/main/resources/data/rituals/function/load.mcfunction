...
tellraw @a [{"text":"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━","color":"dark_purple"}]
tellraw @a [{"text":"│","color":"dark_purple"}]
tellraw @a [{"text":"│","color":"dark_purple"},{"text":"  Press ","color":"gray"},{"text":"L","color":"aqua","bold":true},{"text":" to open the Advancement Guide","color":"gray"}]
tellraw @a [{"text":"│","color":"dark_purple"},{"text":"  Type ","color":"gray"},{"text":"/rituals help","color":"green","underlined":true,"click_event":{"action":"run_command","command":"/rituals help"},"hover_event":{"action":"show_text","value":"Click to run command"}},{"text":" for all commands","color":"gray"}]
tellraw @a [{"text":"│","color":"dark_purple"}]
tellraw @a [{"text":"│","color":"dark_purple"},{"text":"  Quick Commands:","color":"yellow","bold":true}]
tellraw @a [{"text":"│","color":"dark_purple"},{"text":"   • ","color":"dark_gray"},{"text":"/rituals guidebook","color":"green","underlined":true,"click_event":{"action":"run_command","command":"/rituals guidebook"},"hover_event":{"action":"show_text","value":"Get the ritual guidebook"}},{"text":" - Get guidebook","color":"gray"}]
tellraw @a [{"text":"│","color":"dark_purple"},{"text":"   • ","color":"dark_gray"},{"text":"/rituals give all","color":"aqua","underlined":true,"click_event":{"action":"run_command","command":"/rituals give all"},"hover_event":{"action":"show_text","value":"Give all totem items"}},{"text":" - Get all totems","color":"gray"}]
tellraw @a [{"text":"│","color":"dark_purple"},{"text":"   • ","color":"dark_gray"},{"text":"/rituals badges check_status","color":"gold","underlined":true,"click_event":{"action":"run_command","command":"/rituals badges check_status"},"hover_event":{"action":"show_text","value":"View your ritual progress"}},{"text":" - Badge status","color":"gray"}]
tellraw @a [{"text":"│","color":"dark_purple"},{"text":"   • ","color":"dark_gray"},{"text":"/rituals config reload","color":"light_purple","underlined":true,"click_event":{"action":"run_command","command":"/rituals config reload"},"hover_event":{"action":"show_text","value":"Reload configuration"}},{"text":" - Reload config","color":"gray"}]
tellraw @a [{"text":"│","color":"dark_purple"}]
