...
tellraw @s [{"text":"  /function rituals:get","color":"aqua","underlined":true,"click_event":{"action":"run_command","command":"/function rituals:get"},"hover_event":{"action":"show_text","value":[{"text":"Click to get all items","color":"green"}]}},{"text":" - Get all ritual items","color":"white"}]
tellraw @s [{"text":"","color":"yellow"}]
