...
# DEBUG: Show timer every 5 seconds
...
# DEBUG: Farming attempt happening
tellraw @a[distance=..10] [{"text":"[DEBUG FARM] Farming attempt now!","color":"green","bold":true}]
...
tellraw @a[distance=..10] [{"text":"[DEBUG FARM] Calling tier-specific farming","color":"red","bold":true}]
