...
execute if data storage rituals:temp {check_square_item:"minecraft:potato"} run scoreboard players add #totems_found rituals.temp 1
execute if data storage rituals:temp {check_square_item:"minecraft:potato"} run tag @s add rituals.pattern_totem
