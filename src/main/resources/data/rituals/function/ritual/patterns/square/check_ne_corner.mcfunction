...
execute if data storage rituals:temp {check_square_item:"minecraft:wheat"} run scoreboard players add #totems_found rituals.temp 1
execute if data storage rituals:temp {check_square_item:"minecraft:wheat"} run tag @s add rituals.pattern_totem
