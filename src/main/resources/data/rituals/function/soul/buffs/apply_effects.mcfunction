...
# Reads buff/debuff levels directly from SelectedItem (no storage copy).
# Effects scale with stack level.

# DEBUG — remove this line once effects are confirmed working
execute if entity @a[tag=rituals.debug] run tellraw @s [{"text":"[DEBUG] ","color":"dark_gray"},{"text":"apply_effects running","color":"gray"}]

# === EXTRACT BUFF LEVELS (direct from held item) ===
# Default all to 0, then overwrite from item data.
# If the data path doesn't exist, the score stays at 0.
...
# Read directly from SelectedItem — no storage intermediary
execute store result score #haste_lvl rituals.soul_temp run data get entity @s SelectedItem.components."minecraft:custom_data".soul_buff_levels.haste
execute store result score #reach_lvl rituals.soul_temp run data get entity @s SelectedItem.components."minecraft:custom_data".soul_buff_levels.reach
execute store result score #lucky_lvl rituals.soul_temp run data get entity @s SelectedItem.components."minecraft:custom_data".soul_buff_levels.lucky
execute store result score #swift_lvl rituals.soul_temp run data get entity @s SelectedItem.components."minecraft:custom_data".soul_buff_levels.swift
execute store result score #strong_lvl rituals.soul_temp run data get entity @s SelectedItem.components."minecraft:custom_data".soul_buff_levels.strong
execute store result score #tough_lvl rituals.soul_temp run data get entity @s SelectedItem.components."minecraft:custom_data".soul_buff_levels.tough
execute store result score #repair_lvl rituals.soul_temp run data get entity @s SelectedItem.components."minecraft:custom_data".soul_buff_levels.repair
execute store result score #magnetic_lvl rituals.soul_temp run data get entity @s SelectedItem.components."minecraft:custom_data".soul_buff_levels.magnetic
execute store result score #soulfire_lvl rituals.soul_temp run data get entity @s SelectedItem.components."minecraft:custom_data".soul_buff_levels.soulfire
execute store result score #lifesteal_lvl rituals.soul_temp run data get entity @s SelectedItem.components."minecraft:custom_data".soul_buff_levels.lifesteal
...
execute store result score #looting_lvl rituals.soul_temp run data get entity @s SelectedItem.components."minecraft:custom_data".soul_buff_levels.looting
execute store result score #unbreaking_lvl rituals.soul_temp run data get entity @s SelectedItem.components."minecraft:custom_data".soul_buff_levels.unbreaking
execute store result score #glow_lvl rituals.soul_temp run data get entity @s SelectedItem.components."minecraft:custom_data".soul_buff_levels.glow
execute store result score #nimble_lvl rituals.soul_temp run data get entity @s SelectedItem.components."minecraft:custom_data".soul_buff_levels.nimble
execute store result score #nightvision_lvl rituals.soul_temp run data get entity @s SelectedItem.components."minecraft:custom_data".soul_buff_levels.nightvision
execute store result score #waterbreath_lvl rituals.soul_temp run data get entity @s SelectedItem.components."minecraft:custom_data".soul_buff_levels.waterbreath
execute store result score #fireresist_lvl rituals.soul_temp run data get entity @s SelectedItem.components."minecraft:custom_data".soul_buff_levels.fireresist
execute store result score #saturation_lvl rituals.soul_temp run data get entity @s SelectedItem.components."minecraft:custom_data".soul_buff_levels.saturation
execute store result score #heavy_lvl rituals.soul_temp run data get entity @s SelectedItem.components."minecraft:custom_data".soul_debuff_levels.heavy
execute store result score #unlucky_lvl rituals.soul_temp run data get entity @s SelectedItem.components."minecraft:custom_data".soul_debuff_levels.unlucky
execute store result score #hungry_lvl rituals.soul_temp run data get entity @s SelectedItem.components."minecraft:custom_data".soul_debuff_levels.hungry
execute store result score #fragile_lvl rituals.soul_temp run data get entity @s SelectedItem.components."minecraft:custom_data".soul_debuff_levels.fragile
execute store result score #clumsy_lvl rituals.soul_temp run data get entity @s SelectedItem.components."minecraft:custom_data".soul_debuff_levels.clumsy
execute store result score #gluttony_lvl rituals.soul_temp run data get entity @s SelectedItem.components."minecraft:custom_data".soul_debuff_levels.gluttony
execute store result score #cursed_lvl rituals.soul_temp run data get entity @s SelectedItem.components."minecraft:custom_data".soul_debuff_levels.cursed
execute store result score #paranoid_lvl rituals.soul_temp run data get entity @s SelectedItem.components."minecraft:custom_data".soul_debuff_levels.paranoid
execute store result score #loud_lvl rituals.soul_temp run data get entity @s SelectedItem.components."minecraft:custom_data".soul_debuff_levels.loud
execute store result score #bloodthirst_lvl rituals.soul_temp run data get entity @s SelectedItem.components."minecraft:custom_data".soul_debuff_levels.bloodthirst
...
# Glow - Make nearby entities glow (so the wielder can see them)
execute if score #glow_lvl rituals.soul_temp matches 1.. run effect give @e[distance=..10,type=!player] glowing 2 0 true
...
# Nimble - Jump boost
execute if score #nimble_lvl rituals.soul_temp matches 1.. run effect give @s jump_boost 2 0 true
...
# Night vision
execute if score #nightvision_lvl rituals.soul_temp matches 1.. run effect give @s night_vision 15 0 true

# Water breathing
execute if score #waterbreath_lvl rituals.soul_temp matches 1.. run effect give @s water_breathing 10 0 true

# Fire resistance
execute if score #fireresist_lvl rituals.soul_temp matches 1.. run effect give @s fire_resistance 10 0 true

# Saturation - tiny chance (0.5% per tick)
...
execute if score #saturation_lvl rituals.soul_temp matches 1.. if score #sat_roll rituals.soul_temp matches 1 run effect give @s saturation 1 0 true
...
# Hungry - chance for hunger effect
...
execute if score #hungry_lvl rituals.soul_temp matches 1 if score #hunger_roll rituals.soul_temp matches 1 run effect give @s hunger 3 0 true
...
execute if score #hungry_lvl rituals.soul_temp matches 2 if score #hunger_roll rituals.soul_temp matches 1 run effect give @s hunger 3 0 true

# Cursed - Bad omen rarely
...
execute if score #cursed_lvl rituals.soul_temp matches 1.. if score #curse_roll rituals.soul_temp matches 1 run effect give @s bad_omen 600 0 true

# Clumsy - Mining fatigue sometimes
...
execute if score #clumsy_lvl rituals.soul_temp matches 1 if score #clumsy_roll rituals.soul_temp matches 1 run effect give @s mining_fatigue 3 0 true
...
execute if score #clumsy_lvl rituals.soul_temp matches 2 if score #clumsy_roll rituals.soul_temp matches 1 run effect give @s mining_fatigue 3 0 true

# Paranoid - Random spooky sounds
