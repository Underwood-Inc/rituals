# ========================================
# Axe Combat Action - Axes can fight too!
# ========================================
...
# === CALCULATE XP DELTA ===
scoreboard players operation @s rituals.axe_kills = #total rituals.soul_temp
execute unless score @s rituals.prev_axe_kills matches 0.. run scoreboard players operation @s rituals.prev_axe_kills = @s rituals.axe_kills
scoreboard players operation #xp_gain rituals.soul_temp = @s rituals.axe_kills
scoreboard players operation #xp_gain rituals.soul_temp -= @s rituals.prev_axe_kills

# === AWARD XP ===
execute if score #xp_gain rituals.soul_temp matches 1.. run function rituals:soul/award_xp
scoreboard players operation @s rituals.prev_axe_kills = @s rituals.axe_kills
