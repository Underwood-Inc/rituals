# ========================================
# Combat Action - Sword/Melee XP (Full Mob Tracking)
# ========================================
# Tracks ALL mob kills and awards XP based on mob type
# Minecraft 1.21.11 - Complete mob mapping
...
# === PASSIVE MOBS (2 XP each - farming) ===
...
# === CALCULATE XP DELTA ===
scoreboard players operation @s rituals.sword_kills = #total rituals.soul_temp
execute unless score @s rituals.prev_kills matches 0.. run scoreboard players operation @s rituals.prev_kills = @s rituals.sword_kills
scoreboard players operation #xp_gain rituals.soul_temp = @s rituals.sword_kills
...
scoreboard players operation @s rituals.prev_kills = @s rituals.sword_kills
